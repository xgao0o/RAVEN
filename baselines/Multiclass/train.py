...
# - Causal attention, CE loss with ignore_index=-1
# - Optional Rotary Embeddings (rope/xpos)
# - Works with UnifiedSeqEHRDataset + custom_collate (targets already prepared)
...
while True:
    ...
    for batch in train_loader:
        ...
        with ctx:
            logits, loss = model(tokens, targets=targets, days=days, patient_ids=pids)
